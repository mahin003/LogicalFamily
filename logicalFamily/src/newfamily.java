...
public class newfamily extends javax.swing.JFrame {
    public newfamily() {
        try {
            ...
            f = new Formatter("E:/NetBeansProjects/JavaProject/newfamilyDATA.txt");
    ...
    private void initComponents() {
        ...
        jButton3.setFont(new java.awt.Font("Myriad Pro", 1, 24)); // NOI18N
   ...
   f.close();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        gender =jTextField4.getText();System.out.println(name+" "+father+"  "+mother+" "+gender);gender=gender.toLowerCase();
